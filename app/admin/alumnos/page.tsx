  ...
  return (
    <div className="p-10 max-w-6xl">
      <div className="mb-8 flex items-start justify-between gap-4 flex-wrap">
        ...
        <Link
          href="/admin/alumnos/nueva?returnTo=/admin/alumnos"
          className="inline-flex items-center gap-2 bg-bone text-ink px-4 py-2.5 rounded-full text-xs font-mono uppercase tracking-wider hover:bg-lumen transition-colors shrink-0"
        >
