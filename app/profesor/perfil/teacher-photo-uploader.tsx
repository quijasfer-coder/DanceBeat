...
/**
 * Sube la foto de perfil de una coreógrafa a un bucket PÚBLICO de
 * Storage (`teacher-photos`) y emite la URL pública resultante.
 * Mismo patrón que StudentPhotoUploader, bucket distinto.
 */
export function TeacherPhotoUploader({
  fileNamePrefix = "profesor",
  onChange,
  initialUrl = null,
}: {
    ...
    <div className="flex items-center gap-4">
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-[10px] font-mono uppercase tracking-wider text-bone-mute">
          Opcional · para que te reconozcan en el sitio
        </p>
        {error && (
